...
class ColorSchema {
  ...
  static const Color darkGreen = const Color(0xff88AB8E);

  static const Color lightGreen = const Color(0xffAFC8AD);

  static const Color grey = const Color(0xffF2F1EB);

  static const Color lightBrown = const Color(0xffEEE7DA);

  static const Color darkgrey = Color(0xff625f6a);

  static const Color yellow = Color(0xfffbbd5c);

  static const Color violet = Color(0xEF8354ff);
